...
class Program
{
    static async Task Main()
    {
        ...
        var name = "Mike";
        var age = 38;
        abstraction.InfoFormat($"{name} {age}");
        abstraction.InfoFormat("Name:" + name + " age " + age);

        //abstraction.InfoFormat("Evaluated as {2} [Sym={0} Prop={1}] Eval={2}", "Q", "W", "E");

        abstraction.InfoFormat("Hello, {Name}{Age}!", "Mike", 1);

        //abstraction.InfoFormat("Hello, {Name}!", "Mike", "123");
        //abstraction.InfoFormat("Hello, {Name}{ABC}{SSS}!", "Mike", "333");

        //serilog.Information("Hello, {Name}!", "Mike", "Blah");
        //serilog.Information("Hello, {Name}{ABC}{SSS}!", "Mike", "Blah");
        ...
        LogHelper.InfoFormat(abstraction, null, "Updating profile for {@User}", user);
        LogHelper.InfoFormat(abstraction, null, "Updating profile for {User}", user);
